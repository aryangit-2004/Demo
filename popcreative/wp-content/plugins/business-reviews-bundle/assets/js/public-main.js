...
(function(a, b) {
    ...
    function a(a) {
        ...
        c.destroyed && (c.destroyed = !1, a.options.container && r(a.options.container, function(a) {
            t(a, "scroll", c.validateT)
        }), t(window, "resize", c.saveViewportOffsetT), t(window, "resize", c.validateT), t(window, "scroll", c.validateT));
        b(a)
    }
    ...
    function b(a) {
        for (var b = a._util, g = 0; g < b.count; g++) {
            ...
            m.container && w && (e = e.closest(m.containerClass)) ? (e = e.getBoundingClientRect(), m = c(e, u) ? c(f, {
                top: e.top - m.offset,
                right: e.right + m.offset,
                bottom: e.bottom + m.offset,
                left: e.left - m.offset
            }) : !1) : m = c(f, u);
            if (m || n(d, a.options.successClass)) a.load(d), b.elements.splice(g, 1), b.count--, g--
        }
        0 === b.count && a.destroy()
    }
    ...
    function d(a, b, c) {
        if (!n(a, c.successClass) && (b || c.loadInvisible ||
            ...
            if (b = a.getAttribute(y) || a.getAttribute(c.src)) {
                ...
                if (d || void 0 === a.src) {
                    var m = new Image,
                        ...
                        q = function() {
                            d ? e || l(a, g, k) : a.style.backgroundImage = 'url("' + g + '")';
                            f(a, c);
                            p(m, "load", q);
                            p(m, "error", v)
                        };
                    e && (m = a, r(b.getElementsByTagName("source"),
                        function(a) {
                            var b = c.srcset,
                                g = a.getAttribute(b);
            ...
            } else "video" === a.nodeName.toLowerCase() ? (r(a.getElementsByTagName("source"), function(a) {
                var b = c.src,
                    g = a.getAttribute(b);
                g && (a.setAttribute("src", g), a.removeAttribute(b))
            }), a.load(), f(a, c)) : (c.error && c.error(a, "missing"), h(a, c.errorClass))
    }
    ...
    function q(a) {
        u.bottom = (window.innerHeight || document.documentElement.clientHeight) + a;
    ...
    function r(a, b) {
        if (a && b)
            for (var c = a.length, k = 0; k < c && !1 !== b(a[k], k); k++);
    }
    ...
    return function(c) {
        ...
        g.load = function(a, b) {
            var c = this.options;
            void 0 === a.length ? d(a, b, c) : r(a, function(a) {
                d(a, b, c)
            })
        };
        g.destroy = function() {
            var a = this._util;
            this.options.container && r(this.options.container, function(b) {
        ...
        e.validateT = v(function() {
            b(g)
        }, g.options.validateDelay, g);
        e.saveViewportOffsetT = v(function() {
            q(g.options.offset)
...
var WPacTime = WPacTime || {
    ...
    getTimeAgo: function(a, b) {
        ...
        return 45 > a ? WPacTime.Messages[b].second : 90 > a ? WPacTime.Messages[b].minute : 45 > c ? WPacTime.Messages[b].minutes(c) : 90 > c ? WPacTime.Messages[b].hour : 24 > d ? WPacTime.Messages[b].hours(d) : 48 > d ? WPacTime.Messages[b].day : 30 > f ? WPacTime.Messages[b].days(f) : 60 > f ? WPacTime.Messages[b].month : 365 > f ? WPacTime.Messages[b].months(f) : 2 > l ? WPacTime.Messages[b].year : WPacTime.Messages[b].years(l)
    },
    ...
    declineMsg: function(a, b, c, d, f) {
        var l = a % 10;
        return 1 == l && (1 == a || 20 < a) ? b : 1 < l && 5 > l && (20 < a || 10 > a) ? c : a ? d : f
    }
};
WPacTime.Messages = {
    ru: {
...
function simple_star(a, b, c) {
    return '<svg viewBox="0 0 1792 1792" width="17" height="17" ' + (c ? 'style="background:' + c + '"' : "") + '><use xlink:href="#rp-star' + a + '" fill="' + b + '"/></svg>'
}

function simple_stars(a, b) {
    for (var c = "", d = 1; 6 > d; d++) {
        var f = a - d;
        c = 0 <= f ? c + simple_star("", b) : -1 < f && 0 > f ? -.75 > f ? c + simple_star("-o", b) : -.25 < f ? c + simple_star("", b) : c + simple_star("-half", b) : c + simple_star("-o", b)
    }
    return c
}

function yelp_stars(a, b, c) {
    for (var d = "", f = 0; 5 > f; f++) d += simple_star("", b, 1 <= a - f ? c : 0 < a - f ? "linear-gradient(90deg, " + c + " 50%, #bbbac0 50%)" : "");
    return d
}
...
function render_rplg_logo(a) {
    return "summary" == a ? "" : '<span class="rplg-social-logo rplg-' + a + '-logo">' + render_logo(a) + "</span>"
}

function _rplg_add_svg() {
    var a = document.getElementById("rplg-svg");
    a || (a = document.createElement("span"), a.id = "rplg-svg", a.style.display = "none", a.innerHTML = rplg_svg(), document.body.appendChild(a))
}
...
function _rplg_init_svg(a) {
    ...
    for (c = 0; c < b.length; c++) b[c].innerHTML = render_rplg_logo(b[c].getAttribute("data-badge"));
    a = a.querySelectorAll(".rplg [data-logo]");
    for (c = 0; c < a.length; c++) a[c].innerHTML = render_logo(a[c].getAttribute("data-logo"))
}
...
function _rplg_badge_init(a) {
    ...
    for (var c = document.createElement("div"), d = 0; d < a.length; d++) {
        ...
        (function(a, d, e, f, h, l, m, k) {
            b && (a.style.display =
                "block");
            m && (e && JSON.parse(e).hide && (a.style.display = "none"), m.onclick = function() {
                a.style.display = "none";
                var b = JSON.parse(sessionStorage.getItem(d) || "{}");
                b.hide = !0;
                sessionStorage.setItem(d, JSON.stringify(b))
            });
            h && "summary" != f && (h.innerHTML = render_logo(f));
...
function rplg_next_reviews(a) {
    ...
    for (var c = 0; c < a && c < reviews.length; c++) reviews[c] && (reviews[c].className = reviews[c].className.replace("rplg-hide", ""));
    reviews = b.querySelectorAll(".rplg .rplg-hide");
...
function _rplg_init_slider(a, b) {
    ...
    b.pagin && (d.paginationClickable = !0, d.pagination = ".rplgsw-pagination");
    b.nextprev && (d.nextButton = a.querySelector(".rplg-slider-next"), d.prevButton = a.querySelector(".rplg-slider-prev"));
...
function _rplg_init_sliderlite(a, b) {
    ...
    function d() {
        ...
        if (l) {
            ...
            for (var m = 0; m < h; m++) {
                ...
                x = Math.ceil((b.scrollLeft + (b.scrollLeft + c[0].offsetWidth * d)) / 2 * h / b.scrollWidth);
                ...
                k.onclick = function() {
                    ...
                    b < c ? f(k * Math.abs(c - b)) : e.scrollBy(-q[0].offsetWidth * k * Math.abs(c - b), 0);
    ...
    function l() {
        ...
        (2 > Math.abs(b.left - c.left) || b.left <= c.left) && c.left < b.right && (2 > Math.abs(b.right -
            c.right) || b.right >= c.right) && c.right > b.left ? e.scrollBy(-e.scrollWidth, 0) : f(1);
        p = setTimeout(l, h)
    }
    var n = a.querySelector(".grw-slider"),
        ...
        p = null,
        r = function() {
            (n.offsetWidth || n.offsetHeight || n.getClientRects().length) && "hidden" !== window.getComputedStyle(n).visibility ? (c(), _rplg_init_blazy(10), q.length && setTimeout(l, h)) : setTimeout(r, 300)
        };
    r();
    ...
    if (b = a.querySelector(".grw-slider-prev")) b.onclick = function() {
        e.scrollBy(-q[0].offsetWidth, 0);
        p && clearInterval(p)
    };
    if (b = a.querySelector(".grw-slider-next")) b.onclick = function() {
        f(1);
        p && clearInterval(p)
    }
}
...
function _rplg_init_flash(a, b) {
    ...
    if (!sessionStorage.getItem(c)) {
        ...
        for (var u = a.querySelectorAll(".rplg-form-review"), z = 0; z < u.length; z++) {
            var w = u[z],
                m = w.querySelector(".rplg-stars").getAttribute("data-info").split(",");
            if (b.disable_review_time) var k = "";
            else k = w.querySelector(".rplg-review-time"), k = b.time_format ? k.innerText : k.getAttribute("data-time");
            n.push({
                avatar: b.hide_avatar ? "" : w.querySelector(".rplg-review-avatar").getAttribute(b.lazy_load_img ? "data-src" : "src"),
                author_name: b.hide_name ? "" : w.querySelector(".rplg-review-name").getAttribute("title"),
                time: k,
                rating: m[0],
                provider: m[1]
            })
        ...
        var g = function(c) {
            f || l || (_rplg_flashnext(a, t, d, n, b), h.className = "rplg-flash-content rplg-flash-visible", d = d + 1 < n.length ? d + 1 : 0);
            l = !1;
        ...
        t.onclick = function() {
            ...
            var a = q.querySelector(".rplg-row").getAttribute("data-idx"),
                b = q.querySelector('.rplg-form-review[data-idx="' +
                    a + '"]');
...
function _rplg_flashstory(a, b, c) {
    b = b[a];
    return '<div class="rplg-row" data-idx="' + a + '">' + (c.flash_hide_logo && !c.flash_user_photo ? "" : '<div class="rplg-row-left"><div class="rplg-flash-img">' + (c.flash_user_photo ? '<img src="' + b.avatar + '" class="rplg-review-avatar" alt="' + b.author_name + '" width="44" height="44">' : '<span style="position:relative;display:inline-block;margin:0 6px 0 0;vertical-align: middle;"><svg viewBox="0 0 1792 1792" width="44" height="44"><path d="M1728 647q0 22-26 48l-363 354 86 500q1 7 1 20 0 21-10.5 35.5t-30.5 14.5q-19 0-40-12l-449-236-449 236q-22 12-40 12-21 0-31.5-14.5t-10.5-35.5q0-6 2-20l86-500-364-354q-25-27-25-48 0-37 56-46l502-73 225-455q19-41 49-41t49 41l225 455 502 73q56 9 56 46z" fill="#FFAF02"></path></svg><span style="position:absolute;bottom:0px;right:0px;width:26px;height:26px;background:#fff;border-radius:50%;border:4px solid #212121"></span><svg width="25" height="25" viewBox="0 0 1792 1792" style="position:absolute;bottom:0;right:0;border-radius:50%;background:#fff"><path d="M1299 813l-422 422q-19 19-45 19t-45-19l-294-294q-19-19-19-45t19-45l102-102q19-19 45-19t45 19l147 147 275-275q19-19 45-19t45 19l102 102q19 19 19 45t-19 45zm141 83q0-148-73-273t-198-198-273-73-273 73-198 198-73 273 73 273 198 198 273 73 273-73 198-198 73-273zm224 0q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z" fill="#8cc976"></path></svg></span>') +
...
function _rplg_flashtext(a, b) {
    ...
    return '<span class="rplg-flash-star rplg-stars" data-provider="' + a.provider + '" data-info="' + c + '">' + render_stars(a.rating, a.provider) + "</span> " + b.text.m2 + ' <span class="rplg-flash-logo" data-provider="' + a.provider + '">' + render_logo(a.provider) + "</span>"
}
...
document.addEventListener("DOMContentLoaded", function() {
    for (var a = document.querySelectorAll('.rplg img[data-exec="false"]'), b = 0; b < a.length; b++) {
        var c = a[b];
...
var RichPlugins = RichPlugins || {
    ...
    Utils: {
        ...
        ajax: function(a, b) {
            ...
            c.onreadystatechange = function() {
                c.readyState === XMLHttpRequest.DONE && 200 === c.status && b(JSON.parse(c.responseText))
            };
            c.send()
        },
        time: function(a, b) {
        ...
        trimtext: function(a, b, c) {
            if (a && b && a.length > b) {
                var d = a.substring(0, b).indexOf(" ") +
                    1;
                if (1 > d || b - d > b / 2) d = b;
                var f = b = "";
                0 < d && (b = a.substring(0, d - 1), f = a.substring(d - 1, a.length));
                return b + (f ? "<rp-s>... </rp-s><rp-h>" + f + "</rp-h><rp-readmore>" + this.__("read more", c) + "</rp-readmore>" : "")
            }
            return a
        },
        opentext: function() {
        ...
        anchor: function(a, b, c) {
            ...
            return '<a href="' + a + '" ' + (c.open_link ? 'target="_blank"' : "") + " " + d + ">" + b + "</a>"
        },
        media: function(a) {
            for (var b = document.createElement("rp-media"), c = 0; c < a.length; c++) {
                var d = document.createElement("rp-thumb");
                d.setAttribute("onclick", "_rplg_popup('" + a[c].googleUrl + "', 800, 600)");
                d.setAttribute("style", "background-image:url(" + a[c].thumbnailUrl + ")");
        ...
        reviewInit: function(a, b) {
            ...
            c && (c.innerHTML = RichPlugins.Utils.time(c.getAttribute("data-time"), b.time_format));
            d.innerHTML && (d.innerHTML = RichPlugins.Utils.trimtext(d.innerHTML, b.text_size, b.trans), b = d.querySelector("rp-readmore")) && (b.onclick = RichPlugins.Utils.opentext)
        },
        starsInit: function(a) {
            var b = a.getAttribute("data-info").split(",");
            a.innerHTML =
                render_stars(b[0], b[1], b[2])
        }
    },
    Tag: function(a) {
        ...
        return d = {
            init: function() {
                ...
                n && (RichPlugins.Utils.starsInit(n), n.onclick = function(a) {
                    a = "svg" == a.target.tagName ? a.target : a.target.parentNode;
                    a = [].concat($jscomp.arrayFromIterable(a.parentNode.children)).indexOf(a);
                    _rplg_popup(2 < a ? this.getAttribute("data-reviewus") : "https://app.richplugins.com/feedback?s=" + a, 800, 600)
                });
                for (l = 0; l < f.length; l++) f[l].innerHTML = render_logo(f[l].getAttribute("data-provider"));
                0 < c.tag_popup && setTimeout(function() {
                ...
                if ("sidebar" == c.tag_click) {
                    ...
                    a.onclick = function(a) {
                        h.style.display = "none" == h.style.display ?
                            "block" : "none";
                        var d = h.querySelector("rp-sbci");
                        "" == d.innerHTML && RichPlugins.Utils.ajax(brb_vars.ajaxurl + "?action=brb_embed&id=" + b + "&brb_view_mode=" + c.tag_sidebar, function(a) {
                            d.innerHTML = a.data;
            ...
            stylesInit: function() {
                var a = "",
                    b = document.getElementById("rplg-style") || document.createElement("style");
                b.id = "rplg-style";
                c.tag_color && (a += "r-p rp-tag-inner{background:" + c.tag_color + "!important}");
                c.tag_color_text && (a += "r-p rp-tag rp-tag-text{color:" + c.tag_color_text + "!important}");
                c.tag_color_rating && (a += "r-p rp-tag-inner rp-rating{color:" + c.tag_color_rating + "!important}");
                c.tag_size_logo && (a += "r-p rp-tag rp-logo svg{width:" + c.tag_size_logo + "!important;height:" + c.tag_size_logo + "!important}");
                c.tag_size_star && (a += "r-p rp-tag rp-stars svg{width:" + c.tag_size_star + "!important;height:" + c.tag_size_star + "!important}");
                c.tag_size_rating &&
                    (a += "r-p rp-tag rp-rating{font-size:" + c.tag_size_rating + "!important}");
                b.innerHTML = a;
    ...
    Slider: function(a) {
        ...
        return e = {
            init: function() {
                e.isVisible(a) ? (setTimeout(function() {
                    e.resize();
                    e.actions()
                }, 1), q.length && e.swipeAutoStart()) : setTimeout(e.init, 300);
            ...
            resize: function(b) {
                ...
                var l = 510 > c ? "xs" : 750 > c ? "x" : 1100 > c ? "s" : 1450 > c ? "m" : 1800 >
                    c ? "l" : "xl";
                ...
                }!q.length || t == l && k == a.getAttribute("data-col") || setTimeout(function() {
                    d.scrollLeft != b * e.reviewWidth() && (d.scrollLeft = b * e.reviewWidth());
                    e.dotsInit();
                    e.setActiveDot();
                    t = l
                }, 200);
            ...
            actions: function() {
                ...
                d && (d.addEventListener("scroll", e.scrollListener, !1), h.wheelscroll && c.addEventListener("wheel", e.wheelListener, !1));
                var b = a.querySelector("rp-btn-prev");
                b && (b.onclick = function() {
                    e.btnClick(-1)
                });
                if (b = a.querySelector("rp-btn-next")) b.onclick = function() {
                    e.btnClick(1)
                }
            },
            ...
            wheelListener: function(a) {
                var b = a.target;
                if ((b = "RP-REVIEW-TEXT" == b.tagName ? b : "RP-REVIEW-TEXT" == b.parentNode.tagName ? b.parentNode : null) && b.scrollHeight > b.clientHeight) return !0;
                a.preventDefault();
                w++;
                clearTimeout(y);
            ...
            stylesInit: function() {
                var a = "",
                    b = document.getElementById("rplg-style") || document.createElement("style");
                b.id = "rplg-style";
                h.color_review && (a += "r-p rp-review rp-review-inner{background:" + h.color_review + "!important}");
                h.color_border && (a += "r-p rp-review rp-review-inner{box-shadow:none!important;border:1px solid " + h.color_border + "!important}");
                h.color_text && (a += "r-p rp-review rp-review-inner{color:" + h.color_text + "!important}");
                h.slider_space_between && (a += "r-p rp-review rp-review-inner{margin:0 " + h.slider_space_between + "!important}");
                h.slider_review_height && (a += "r-p [data-rs] rp-review rp-body{height:" + h.slider_review_height + "!important}");
                h.color_scale && (a += "r-p rp-header rp-scale{color:" + h.color_scale + "!important}");
                h.color_based && (a += "r-p rp-header rp-based{color:" + h.color_based + "!important}");
                h.color_name && (a += "r-p rp-review rp-review-name,r-p rp-review rp-review-name a{color:" + h.color_name + "!important}");
                h.color_time && (a += "r-p rp-review rp-review-time{color:" + h.color_time + "!important}");
                h.color_stars && (a += "r-p rp-header rp-rating{color:" + h.color_stars + "!important}");
                h.color_btn && (a += "r-p rp-header rp-review_us,r-p rp-header rp-review_us:hover,r-p rp-header rp-review_us:active{background:" + h.color_btn + "!important}");
                h.color_dot && (a += "r-p rp-dot.active {background:" + h.color_dot + "}");
                b.innerHTML = a;
                document.head.appendChild(b)
            },
            headerInit: function() {
                ...
                for (b = 0; b < c.length; b++) c[b].innerHTML = render_logo(c[b].getAttribute("data-provider"))
            },
            ...
            scrollEnd: function() {
                ...
                e.setActiveDot();
                (!h.mousestop || u) && h.mousestop || (!h.clickstop || z) && h.clickstop || e.swipeAutoStart()
            },
            loadNextReviews: function() {
                var b = parseInt(a.getAttribute("data-offset")),
                    c = a.querySelector("rp-dot.active");
                c = c ? parseInt(c.getAttribute("data-index")) * e.swipePerDot() : e.reviewsBack();
                c = e.getAjaxSize(c);
                if (0 < c) {
                    var d = [];
            ...
            getAjaxSize: function(b) {
                ...
                if (n > d) {
                    var f = b - d;
                    Math.abs(f) < 3 *
                        e.swipePerDot() ? c = k : f && (c = Math.ceil(b / k) * k - d)
                }
                b = d + c - n;
                return 0 < b ? c - b : c
            },
            ...
            loadAjaxReviews: function(c, d, f) {
                RichPlugins.Utils.ajax(brb_vars.ajaxurl + "?action=brb_get_reviews&id=" + b + "&offset=" + d + "&size=" + f, function(b) {
            ...
            convertReviewEl: function(a, b) {
                var c = a.querySelector("rp-body"),
                    d = a.querySelector("rp-review-img img"),
                ...
                k.setAttribute("data-info", [b.rating, b.provider, h.color_stars].join());
                return a
            },
            dotsInit: function() {
                if (l) {
            ...
            setActiveDot: function() {
                var b = Math.round(e.reviewsBack() /
                    e.swipePerDot()) + 1;
            ...
            isScrollEnd: function() {
                ...
                return (2 > Math.abs(a.left - b.left) || a.left <= b.left) && b.left < a.right && (2 > Math.abs(a.right - b.right) || a.right >= b.right) && b.right > a.left
            },
            swipeStep: function() {
            ...
            reviewsPerView: function() {
                return Math.round(d.offsetWidth /
                    e.reviewWidth())
            },
            ...
            reviewName: function(a) {
                return '<rp-review-name title="' + a.author_name + '">' + (a.author_url ? RichPlugins.Utils.anchor(a.author_url, a.author_name, h) : a.author_name) + "</rp-review-name>"
            },
            clear: function() {
                clearTimeout(p);
                clearTimeout(r);
...
document.addEventListener("DOMContentLoaded", function() {
    for (var a = document.querySelectorAll('rp-slider[data-exec=""]'), b = 0; b < a.length; b++) RichPlugins.Slider(a[b]).init(), a[b].setAttribute("data-exec", "1")
});