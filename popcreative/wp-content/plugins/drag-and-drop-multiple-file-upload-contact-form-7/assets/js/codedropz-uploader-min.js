...
! function(a) {
    a.fn.CodeDropz_Uploader = function(e) {
        a("form.wpcf7-form").length > 0 && (a("form.wpcf7-form"), a.post(dnd_cf7_uploader.ajax_url, {
            action: "_wpcf7_check_nonce",
            _ajax_nonce: dnd_cf7_uploader.ajax_nonce
        }, function(a) {
            a.success && a.data && (dnd_cf7_uploader.ajax_nonce = a.data)
        })), this.each(function() {
            var d = a(this),
                r = a.extend({
                    handler: d,
            ...
            var n = r.handler.parents("form"),
                o = r.handler.parents(".codedropz-upload-wrapper"),
                p = a('input[type="submit"]', n);
            r.handler.after(t), a(".codedropz-upload-handler", o).on("drag dragstart dragend dragover dragenter dragleave drop", function(a) {
                a.preventDefault(), a.stopPropagation()
            }), a(".codedropz-upload-handler", o).on("dragover dragenter", function(e) {
                a(this).addClass("codedropz-dragover")
            }), a(".codedropz-upload-handler", o).on("dragleave dragend drop", function(e) {
                a(this).removeClass("codedropz-dragover")
            }), a("a.cd-upload-btn", o).on("click", function(a) {
                a.preventDefault(), r.handler.val(null), r.handler.click()
            }), a(".codedropz-upload-handler", o).on("drop", function(a) {
            ...
            var l = function(e, t) {
                    if (!(!e.length > 1)) {
                        ...
                        p.append("action", "dnd_codedropz_upload"), p.append("type", t), p.append("security", dnd_cf7_uploader.ajax_nonce), p.append("form_id", d.data("id")), p.append("upload_name", d.data("name")), d.data("black-list") && p.append("blacklist-types", d.data("black-list")), a("span.has-error", r.handler).remove(), a.each(e, function(e, t) {
                            if (void 0 !== p.delete && p.delete("upload-file"), localStorage.getItem(s) > r.max_file) return !a("span.has-error-msg", o).length > 0 && (err_msg = dnd_cf7_uploader.drag_n_drop_upload.max_file_limit, o.append('<span class="has-error-msg">' + err_msg.replace("%count%", r.max_file) + "</span>")), !1;
                            ...
                            t.size > r.max_upload_size && (a(".dnd-upload-details", a("#" + l)).append('<span class="has-error">' + dnd_cf7_uploader.drag_n_drop_upload.large_file + "</span>"), c = !0), regex_type = RegExp("(.*?).(" + r.supported_type + ")$"), !1 !== c || regex_type.test(t.name.toLowerCase()) || (a(".dnd-upload-details", a("#" + l)).append('<span class="has-error">' + dnd_cf7_uploader.drag_n_drop_upload.inavalid_type + "</span>"), c = !0), localStorage.setItem(s, Number(localStorage.getItem(s)) + 1), !1 === c && (p.append("upload-file", t), a.ajax({
                                ...
                                success: function(e) {
                                    e.success ? (i.setProgressBar(l, 100), a.isFunction(r.on_success) && r.on_success.call(this, d, l, e)) : (a(".dnd-progress-bar", a("#" + l)).remove(), a(".dnd-upload-details", a("#" + l)).append('<span class="has-error">' + e.data + "</span>"), a('input[type="submit"]', n).removeClass("disabled").prop("disabled", !1), a("#" + l).removeClass("in-progress"))
                                },
                                error: function(e, d, s) {
                                    a(".dnd-progress-bar", a("#" + l)).remove(), a(".dnd-upload-details", a("#" + l)).append('<span class="has-error">' + r.server_max_error + "</span>"), a('input[type="submit"]', n).removeClass("disabled").prop("disabled", !1), a("#" + l).removeClass("in-progress")
                                }
                            }))
                        })
                    }
                ...
                i = {
                    createProgressBar: function(e) {
                        var d = a(".codedropz-upload-handler", o),
            ...
            var r = a(this),
                ...
                n = r.parent("a").attr("data-storage"),
                o = Number(localStorage.getItem(n));
            if (s.hasClass("in-progress")) return !1;
            if (a(".has-error", s).length > 0) return s.remove(), localStorage.setItem(n, o - 1), !1;
            ...
            a.post(e.ajax_url, p, function(e) {
                e.success && (s.remove(), localStorage.setItem(n, o - 1), a(".dnd-upload-status", t).length <= 1 && a("span.has-error-msg", t).remove(), a(".dnd-upload-counter span", t).text(Number(localStorage.getItem(n)) - 1))
