function oxyThemeScripts(t) {
    function e(e) {
        var i = t(e),
            ...
            h = "thumbnails" === i.attr("data-flex-controls") ? "thumbnails" : "hide" !== i.attr("data-flex-controls"),
            c = "inside" === i.attr("data-flex-controlsposition") ? "flex-controls-inside" : "flex-controls-outside",
            d = i.attr("data-flex-controlsalign") ? "flex-controls-" + i.attr("data-flex-controlsalign") : "flex-controls-center",
            u = i.attr("data-flex-controlsvertical") ? "flex-controls-" + i.attr("data-flex-controlsvertical") : "",
            ...
            g = i.attr("data-flex-itemmin") ? parseInt(i.attr("data-flex-itemmin"), 0) : 0,
            m = "alternate" === i.attr("data-flex-captionhorizontal") ? "flex-caption-alternate" : "flex-caption-" + i.attr("data-flex-captionhorizontal");
        i.addClass(c).addClass(d).addClass(u).addClass(m), i.flexslider({
            slideshow: n,
            animation: o,
            direction: a,
    ...
    function o(t, e, i) {
        ...
        return (i.length && i.hasClass("navbar-sticky") && a + o <= s && !l || l && i.length && i.hasClass("navbar-mobile-stuck") && a + o <= s) && (n += o), n
    }
    ...
    function a(e) {
        ...
        if (void 0 !== h && h.hasClass("navbar-sticky") && c + s <= o && !l || l && void 0 !== h && h.hasClass("navbar-mobile-stuck") && c + s <= o) {
            ...
            n = a <= o ? d : r, n += h.hasClass("header-logo-center-menu-below") || h.hasClass("header-logo-left-menu-below") || h.hasClass("header-logo-right-menu-below") ? h.find(".nav-container").outerHeight() : 0
        }
        t.scrollTo(i, 800, {
            axis: "y",
            offset: -n + 1
    ...
    t(".flexslider[id]").each(function() {
        ...
        success: function(e, i, n) {
            var o = t(i).attr("poster"),
                s = !1;
            "undefined" != typeof o && "" !== o && (s = !0, t(i).parent().css("background-image", "url('" + t(e).attr("poster") + "')"));
            var a = t(i).closest("section");
            i.addEventListener("loadeddata", function() {
                var e = a.outerHeight(),
                    o = a.outerWidth(),
                    s = n.node.videoHeight,
                    r = n.node.videoWidth,
                    l = s / r * 100 + "%",
                    h = o / r,
                    c = s * h;
                t(i).parent().css("padding-bottom", l), c >= e ? t(i).css("top", (e - s * h) / 2) : t(i).css("background-image", ""), t(i).show(), t(window).smartresize(function() {
                    e = a.outerHeight(), o = a.outerWidth(), h = o / r, c = s * h, c >= e ? t(i).css("top", (e - s * h) / 2) : t(i).css("background-image", "")
                })
            }), t('body[class*="oxy-agent-"]').length && (a.on("click", function(t) {
                i.paused ? i.play() : i.pause()
            }), !s && t("body").hasClass("oxy-agent-iphone") || a.find(".mejs-overlay-play").show(), s && (i.addEventListener("pause", function() {
                a.find(".mejs-overlay-play").show(), t(i).hide()
    ...
    }), t("select").not(".country_to_state, #billing_state, #shipping_state, #calc_shipping_state, select.postform").wrap('<div class="select-wrap">');
    var h = t("#masthead"),
    ...
    if (p.length || u.length) {
        ...
        t("article").find("section").each(function() {
            this.id && f.push(this)
        }), f.length && (u.length && d.parent().removeClass("active current-menu-item"), t.each(f, function(e, i) {
            var n = t(i);
            if (p.length) {
                var a = p.find("ul"),
                    r = "";
    ...
    var g = t("body").find(".navbar-sticky");
    if (g.length > 0) {
        new Waypoint.Sticky({
            element: g[0],
    ...
    if (m.length && m.hasClass("navbar-sticky")) {
        var v = m.position().top;
        t("body").waypoint({
            offset: -(parseInt(oxyThemeData.navbarScrolledPoint) + v),
            handler: function(t) {
                m.toggleClass("navbar-scrolled");
                var e = "swatch-",
                    i = m[0].className.split(" ").filter(function(t) {
                        return 0 !== t.lastIndexOf(e, 0)
                    });
                m[0].className = i.join(" "), m.one("MSTransitionEnd webkitTransitionEnd oTransitionEnd transitionend", function() {
    ...
    for (var y = t(".video-wrapper iframe"), w = 0; w < y.length; w++) y[w].src.indexOf("?") === -1 ? y[w].src += "?wmode=opaque" : y[w].src += "&wmode=opaque";
    ...
    b.length > 0 && b.infinitescroll({
        ...
        t(e).each(function(e, i) {
            var n = 3,
                o = t(window).width(),
                s = 2,
                a = b.attr("data-padding");
            o < 768 ? (n = b.attr("data-col-xs"), s = 1) : o < 992 ? (n = b.attr("data-col-sm"), s = 1) : o < 1200 ? (n = b.attr("data-col-md"), s = 2) : o > 1200 && (n = b.attr("data-col-lg"), s = 2);
            var r = Math.floor(b.width() / n),
                l = t(this);
    ...
    }), t(".mini-cart-overview > a").on("click", function(e) {
...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        ...
        if (this.$element.trigger(c), !c.isDefaultPrevented()) {
            ...
            }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (o.removeClass("active"), s.addClass("active"), this.sliding = !1, this.$element.trigger(u)), a && this.cycle(), this
        }
    };
    var n = t.fn.carousel;
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 300, i.BACKDROP_TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        e && e.preventDefault(), e = t.Event("hide.bs.modal"), this.$element.trigger(e), this.isShown && !e.isDefaultPrevented() && (this.isShown = !1,
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                r = "bottom" == r && c.bottom + u > f.bottom ? "top" : "top" == r && c.top - u < f.top ? "bottom" : "right" == r && c.right + d > f.width ? "left" : "left" == r && c.left - d < f.left ? "right" : r, s.removeClass(p).addClass(r)
            }
...
function(t, e, i) {
    ...
    if (a)
        for (n in u) a.hasOwnProperty(n) || a.addTest(n, u[n]);
    else {
        a = t.Modernizr = {
            _version: "1.6ish: miniModernizr for Isotope"
        };
        var p, f = " ";
        for (n in u) p = u[n](), a[n] = p, f += " " + (p ? "" : "no-") + n;
        e("html").addClass(f)
    }
    if (a.csstransforms) {
        var g = a.csstransforms3d ? {
            ...
            m = function(t, i, n) {
                var o, s, a = e.data(t, "isoTransform") || {},
                    ...
                    l = {};
                r[i] = n, e.extend(a, r);
                for (o in a) s = a[o], l[o] = g[o](s);
                var h = l.translate || "",
                    d = l.scale || "",
                    u = h + d;
                e.data(t, "isoTransform", a), t.style[c] = u
            };
    ...
    b.special.smartresize = {
        ...
        handler: function(t, e) {
            var i = this,
                n = arguments;
            t.type = "smartresize", w && clearTimeout(w), w = setTimeout(function() {
                b[C].apply(i, n)
            }, "execAsap" === e ? 0 : 100)
        }
    ...
    e.Isotope.settings = {
        ...
        _processStyleQueue: function(t, i) {
            ...
            if (o = function(t, e) {
                ...
                if (s = !0, r = function() {
                        if (!d) {
                            for (var e, i = 0, n = u.length; i < n; i++) e = u[i], "function" == typeof e && e.call(p.element, t, p);
                            d = !0
                        }
                    }, this.isUsingJQueryAnimation && "animate" === l) h.complete = r, s = !1;
                else if (a.csstransitions) {
                    for (var f, g = 0, m = this.styleQueue[0], w = m && m.$el; !w || !w.length;) {
                        if (f = this.styleQueue[g++], !f) return;
                        w = f.$el
                    }
                    var b = parseFloat(getComputedStyle(w[0])[y]);
                    b > 0 && (o = function(t, e) {
                        e.$el[l](e.style, h).one(v, r)
                    }, s = !1)
                }
            }
        ...
        _masonryPlaceBrick: function(t, e) {
            ...
            for (o = 0; o < h; o++) this.masonry.colYs[n + o] = l
        },
        ...
        _masonryHorizontalPlaceBrick: function(t, e) {
            ...
            for (o = 0; o < h; o++) this.masonryHorizontal.rowXs[n + o] = l
        },
    ...
    e.fn.isotope = function(t, i) {
        if ("string" == typeof t) {
            ...
            this.each(function() {
                ...
                return i ? e.isFunction(i[t]) && "_" !== t.charAt(0) ? void i[t].apply(i, n) : void A("no such method '" + t + "' for isotope instance") : void A("cannot call methods on isotope prior to initialization; attempted to call method '" + t + "'")
            })
...
function(t) {
    ...
    b.prototype = {
        ...
        open: function(i) {
            ...
            e.types = [], a = "", i.mainEl && i.mainEl.length ? e.ev = i.mainEl.eq(0) : e.ev = o, i.key ? (e.popupsCache[i.key] || (e.popupsCache[i.key] = {}), e.currTemplate = e.popupsCache[i.key]) : e.currTemplate = {}, e.st = t.extend(!0, {}, t.magnificPopup.defaults, i), e.fixedContentPos = "auto" === e.st.fixedContentPos ? !e.probablyMobile : e.st.fixedContentPos, e.st.modal && (e.st.closeOnContentClick = !1, e.st.closeOnBgClick = !1, e.st.showCloseBtn = !1, e.st.enableEscapeKey = !1), e.bgOverlay || (e.bgOverlay = A("bg").on("click" + m, function() {
                e.close()
            }), e.wrap = A("wrap").attr("tabindex", -1).on("click" + m, function(t) {
                e._checkIfClose(t.target) && e.close()
            }), e.container = A("container", e.wrap)), e.contentContainer = A("content"), e.st.preloader && (e.preloader = A("preloader", e.container, e.st.tLoading));
            var l = t.magnificPopup.modules;
            for (n = 0; n < l.length; n++) {
                var h = l[n];
                h = h.charAt(0).toUpperCase() + h.slice(1), e["init" + h].call(e)
            }
            T("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (S(u, function(t, e, i, n) {
            ...
            return e.isIE7 && (g += " mfp-ie7"), g && e._addClassToMFP(g), e.updateItemHTML(), T("BuildControls"), t("html").css(d), e.bgOverlay.add(e.wrap).prependTo(document.body), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                e.content ? (e._addClassToMFP(v), e._setFocus()) : e.bgOverlay.addClass(v), o.on("focusin" + m, e._onFocusIn)
            }, 16), e.isOpen = !0, e.updateSize(c), T(p), i
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            e.appendContent(a, n), i.preloaded = !0, T(f, i), s = i.type, e.container.prepend(e.contentContainer), T("AfterChange")
        },
        ...
        if ("string" == typeof i)
            if ("open" === i) {
                var o, s = C ? n.data("magnificPopup") : n[0].magnificPopup,
    ...
    var L, I, M, B = "inline",
        R = function() {
            M && (I.after(M.addClass(L)).detach(), M = null)
        };
            ...
            getInline: function(i, n) {
                if (R(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        a && a.tagName && (I || (L = o.hiddenClass, I = A(L), L = "mfp-" + L), M = s.after(I).detach().removeClass(L)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule(D, {
        ...
        proto: {
            initAjax: function() {
                e.types.push(D), F = e.st.ajax.cursor, S(l + "." + D, _), S("BeforeChange." + D, _)
            },
            getAjax: function(i) {
                F && n.addClass(F), e.updateStatus("loading");
                var o = t.extend({
                    url: i.src,
                    success: function(n, o, s) {
                        ...
                        T("ParseAjax", a), e.appendContent(t(a.data), D), i.finished = !0, O(), e._setFocus(), setTimeout(function() {
                            e.wrap.addClass(v)
        ...
        proto: {
            initImage: function() {
                ...
                e.types.push("image"), S(p + i, function() {
                    ...
                    t.cursor && n.removeClass(t.cursor), x.off("resize" + m)
            ...
            getImage: function(i, n) {
                ...
                if (l.length) {
                    ...
                    h.className = "mfp-img", i.img = t(h).on("load.mfploader", s).on("error.mfploader", a), h.src = i.src, l.is("img") && (i.img = i.img.clone()), i.img[0].naturalWidth > 0 && (i.hasSize = !0)
                }
                return e._parseMarkup(n, {
                    title: W(i),
                    img_replaceWith: i.img
                }, i), e.resizeImage(), i.hasSize ? (z && clearInterval(z), i.loadError ? (n.addClass("mfp-loading"), e.updateStatus("error", r.tError.replace("%url%", i.src))) : (n.removeClass("mfp-loading"), e.updateStatus("ready")), n) : (e.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, n.addClass("mfp-loading"), e.findImageSize(i)), n)
            }
        }
    });
    var j, N = function() {
    ...
    t.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(i) {
                ...
                var r = {
                    width: n.width(),
                    height: (C ? n.innerHeight() : n[0].offsetHeight) - a - s
                };
                return N() ? r["-moz-transform"] = r.transform = "translate(" + o.left + "px," + o.top + "px)" : (r.left = o.left, r.top = o.top), r
            }
        }
    });
    var H = "iframe",
    ...
    t.magnificPopup.registerModule(H, {
        ...
        proto: {
            initIframe: function() {
                e.types.push(H), S("BeforeChange", function(t, e, i) {
                    e !== i && (e === H ? Q() : i === H && Q(!0))
                }), S(l + "." + H, function() {
                    Q()
                })
                ...
                return e.direction = !0, !(!i || !i.enabled) && (a += " mfp-gallery", S(p + n, function() {
                    ...
                    if (e.items.length > 1 && i.arrows && !e.arrowLeft) {
                        ...
                        o[r](function() {
                            ...
                            e.next()
                        }), e.isIE7 && (A("b", o[0], !1, !0), A("a", o[0], !1, !0), A("b", a[0], !1, !0), A("a", a[0], !1, !0)), e.container.append(o.add(a))
                    }
                }), S(f + n, function() {
            ...
            proto: {
                initRetina: function() {
                    if (window.devicePixelRatio > 1) {
                        var t = e.st.retina,
                            i = t.ratio;
                        i = isNaN(i) ? i() : i, i > 1 && (S("ImageHasSize." + G, function(t, e) {
                            e.img.css({
                                "max-width": e.img[0].naturalWidth / i,
                                width: "100%"
                            })
                        }), S("ElementParse." + G, function(e, n) {
                ...
                return t(this).each(function() {
                    ...
                    if (i) {
                        ...
                        r.on("touchstart" + s, function(t) {
                            d = !1, p = 1, u = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], h = u.clientX, c = u.clientY, x.on("touchmove" + s, function(t) {
                                u = t.originalEvent ? t.originalEvent.touches : t.touches, p = u.length, u = u[0], (Math.abs(u.clientX - h) > 10 || Math.abs(u.clientY - c) > 10) && (d = !0, n())
        ...
        for (var i in e) {
            ...
            for (var a in this.waypoints[i]) {
                var r = this.waypoints[i][a],
                    ...
                    c = l && h,
                    d = !l && !h;
                (c || d) && (r.queueTrigger(s), t[r.group.id] = r.group)
            }
        }
...
function() {
    ...
    function(t) {
        ...
        var s, a, r = "[object OperaMini]" == Object.prototype.toString.call(window.operamini),
            ...
            h = "placeholder" in document.createElement("textarea") && !r,
            c = t.valHooks,
            d = t.propHooks;
    ...
    function(t) {
        ...
        return n.defaults = {
                ...
                if (null !== o) {
                    ...
                    switch (typeof p) {
                        ...
                        case "object":
                            ...
                            (p.is || p.style) && (h = (p = t(p)).offset())
                    }
                    var g = t.isFunction(a.offset) && a.offset(d, p) || a.offset;
                    t.each(a.axis.split(""), function(t, e) {
                        var i = "x" === e ? "Left" : "Top",
                            ...
                            m = u[s](),
                            v = n.max(d, e);
                        if (h) f[s] = h[o] + (c ? 0 : m - u.offset()[o]), a.margin && (f[s] -= parseInt(p.css("margin" + i), 10) || 0, f[s] -= parseInt(p.css("border" + i + "Width"), 10) || 0), f[s] += g[o] || 0, a.over[o] && (f[s] += p["x" === e ? "width" : "height"]() * a.over[o]);
                        else {
                            var y = p[o];
            ...
            var a = "client" + o,
                ...
                l = r.documentElement,
                h = r.body;
            return Math.max(l[s], h[s]) - Math.min(l[a], h[a])
    ...
    function(t) {
        ...
        t.infinitescroll = function(e, i, n) {
            ...
            _create: function(i, n) {
                ...
                o.path = o.path || this._determinepath(r), o.contentSelector = o.contentSelector || this.element, o.loading.selector = o.loading.selector || o.contentSelector, o.loading.msg = o.loading.msg || t('<div id="infscr-loading"><img alt="Loading..." src="' + o.loading.img + '" /><div>' + o.loading.msgText + "</div></div>"),
                    (new Image).src = o.loading.img, o.pixelsFromNavToBottom === e && (o.pixelsFromNavToBottom = t(document).height() - t(o.navSelector).offset().top, this._debug("pixelsFromNavToBottom: " + o.pixelsFromNavToBottom));
                var l = this;
            ...
            _loadcallback: function(i, n, o) {
                ...
                switch (l) {
                    ...
                    case "append":
                        ...
                        this._debug("contentSelector", t(a.contentSelector)[0]), t(a.contentSelector)[0].appendChild(s), n = h.get()
                }
                if (a.loading.finished.call(t(a.contentSelector)[0], a), a.animate) {
                    var c = t(window).scrollTop() + t(a.loading.msg).height() + a.extraScrollPx + "px";
                    t("html,body").animate({
                        scrollTop: c
                    }, 800, function() {
                        ...
                        r._debug("Using " + s.toUpperCase() + " via $.ajax() method"), t.ajax({
                            ...
                            success: function(t, s, l) {
                                if (a = "undefined" != typeof l.isResolved ? l.isResolved() : "success" === s || "notmodified" === s, i.appendCallback)
                                    if (i.template !== e) {
                                        var h = i.template(t);
                                        n.append(h), a ? r._loadcallback(n, h) : r._error("end")
                ...
                if (n)
                    for (var s = 0, a = n.length; s < a; ++s) {
                        var r = n[s].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                            ...
                            d = r[3] || "",
                            u = null;
                        r = r[2], l.hasOwnProperty(r) && (u = l[r], u = Number(t[u])), null !== u && ("!" === c && (u = o(d, u)), "" === c && u < 10 && (u = "0" + u.toString()), e = e.replace(h, u.toString()))
                    }
                return e = e.replace(/%%/, "%")
            }
        }
    ...
    function() {
        var t, e, i, n, o, s, a, r, l, h, c, d, u, p, f, g, m, v, y, w, b, C, x, S, A, T, k, E, P, L, I, M, B = [].slice;
        m = '<span class="odometer-value"></span>', p = '<span class="odometer-ribbon"><span class="odometer-ribbon-inner">' + m + "</span></span>", n = '<span class="odometer-digit"><span class="odometer-digit-spacer">8</span><span class="odometer-digit-inner">' + p + "</span></span>", a = '<span class="odometer-formatting-mark"></span>', i = "(,ddd).dd", r = /^\(?([^)]*)\)?(?:(.)(d+))?$/, l = 30, s = 2e3, t = 20, h = 2, o = .5, c = 1e3 / l, e = 1e3 / t, f = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd", A = document.createElement("div").style, g = null != A.transition || null != A.webkitTransition || null != A.mozTransition || null != A.oTransition, x = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, d = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, y = function(t) {
        ...
        })(), setTimeout(E, 0), u = function() {
            function t(e) {
                var i, n, o, a, r, l, d, u, p, f, g = this;
                if (this.options = e, this.el = this.options.el, null != this.el.odometer) return this.el.odometer;
                this.el.odometer = this, u = t.options;
                for (n in u) a = u[n], null == this.options[n] && (this.options[n] = a);
                null == (r = this.options).duration && (r.duration = s), this.MAX_VALUES = this.options.duration / c / h | 0, this.resetFormat(), this.value = this.cleanValue(null != (p = this.options.value) ? p : ""), this.renderInside(), this.render();
                try {
            ...
            return t.prototype.renderInside = function() {
                ...
                if (!this.transitionEndBound) {
                    for (this.transitionEndBound = !0, e = !1, o = f.split(" "), s = [], i = 0, n = o.length; n > i; i++) t = o[i], s.push(this.el.addEventListener(t, function() {
                        return !!e || (e = !0, setTimeout(function() {
                            return a.render(), e = !1, T(a.el, "odometerdone")
                        }, 0), !0)
                    }, !1));
                    return s
                }
                ...
                return h = n.slice(1, 4), a = h[0], s = h[1], e = h[2], o = (null != e ? e.length : void 0) || 0, this.format = {
                    repeating: a,
                    radix: s,
                    precision: o
                }
                ...
                return o.push("odometer"), g || o.push("odometer-no-transitions"), s ? o.push("odometer-theme-" + s) : o.push("odometer-auto-theme"), this.el.className = o.join(" "), this.ribbons = {}, this.formatDigits(t), this.startWatchingMutations()
            }, t.prototype.formatDigits = function(t) {
                var e, i, n, o, s, a, r, l, h, c;
                if (this.digits = [], this.options.formatFunction)
                    for (n = this.options.formatFunction(t), h = n.split("").reverse(), s = 0, r = h.length; r > s; s++) i = h[s], i.match(/0-9/) ? (e = this.renderDigit(), e.querySelector(".odometer-value").innerHTML = i, this.digits.push(e), this.insertDigit(e)) : this.addSpacer(i);
                else
                    for (o = !this.format.precision || !w(t) || !1, c = t.toString().split("").reverse(), a = 0, l = c.length; l > a; a++) e = c[a], "." === e && (o = !0), this.addDigit(e, o)
            }, t.prototype.update = function(t) {
                var e, i = this;
                return t = this.cleanValue(t), (e = t - this.value) ? (C(this.el, "odometer-animating-up odometer-animating-down odometer-animating"), e > 0 ? v(this.el, "odometer-animating-up") : v(this.el, "odometer-animating-down"), this.stopWatchingMutations(), this.animate(t), this.startWatchingMutations(), setTimeout(function() {
                ...
                if (n = +t - this.value) return s = o = b(), i = this.value, (a = function() {
                    var l, h, c;
                    return b() - s > r.options.duration ? (r.value = t, r.render(), void T(r.el, "odometerdone")) : (l = b() - o, l > e && (o = b(), c = l / r.options.duration, h = n * c, i += h, r.render(Math.round(i))), null != x ? x(a) : setTimeout(a, e))
                })()
            }, t.prototype.getDigitCount = function() {
                var t, e, i, n, o, s;
                for (n = 1 <= arguments.length ? B.call(arguments, 0) : [], t = o = 0, s = n.length; s > o; t = ++o) i = n[t], n[t] = Math.abs(i);
                return e = Math.max.apply(Math, n), Math.ceil(Math.log(e + 1) / Math.log(10))
            }, t.prototype.getFractionalDigitCount = function() {
                var t, e, i, n, o, s, a;
                for (o = 1 <= arguments.length ? B.call(arguments, 0) : [], e = /^\-?\d*\.(\d*?)0*$/, t = s = 0, a = o.length; a > s; t = ++s) n = o[t], o[t] = n.toString(), i = e.exec(o[t]), null == i ? o[t] = 0 : o[t] = i[1].length;
                return Math.max.apply(Math, o)
            }, t.prototype.resetDigits = function() {
                return this.digits = [], this.ribbons = [], this.inside.innerHTML = "", this.resetFormat()
            }, t.prototype.animateSlide = function(t) {
                var e, i, n, s, a, r, l, h, c, d, u, p, f, g, m, y, w, b, C, x, S, A, T, E, P, L, I;
                if (y = this.value, h = this.getFractionalDigitCount(y, t), h && (t *= Math.pow(10, h), y *= Math.pow(10, h)), n = t - y) {
                    for (this.bindTransitionEnd(), s = this.getDigitCount(y, t), a = [], e = 0, u = C = 0; s >= 0 ? s > C : C > s; u = s >= 0 ? ++C : --C) {
                        if (w = k(y / Math.pow(10, s - u - 1)), l = k(t / Math.pow(10, s - u - 1)), r = l - w, Math.abs(r) > this.MAX_VALUES) {
                            for (d = [], p = r / (this.MAX_VALUES + this.MAX_VALUES * e * o), i = w; r > 0 && l > i || 0 > r && i > l;) d.push(Math.round(i)), i += p;
                            d[d.length - 1] !== l && d.push(l), e++
                        } else d = function() {
                            I = [];
                            for (var t = w; l >= w ? l >= t : t >= l; l >= w ? t++ : t--) I.push(t);
                            return I
                        }.apply(this);
                        for (u = x = 0, A = d.length; A > x; u = ++x) c = d[u], d[u] = Math.abs(c % 10);
                        a.push(d)
                    }
                    for (this.resetDigits(), L = a.reverse(), u = S = 0, T = L.length; T > S; u = ++S)
                        for (d = L[u], this.digits[u] || this.addDigit(" ", u >= h), null == (b = this.ribbons)[u] && (b[u] = this.digits[u].querySelector(".odometer-ribbon-inner")), this.ribbons[u].innerHTML = "", 0 > n && (d = d.reverse()), f = P = 0, E = d.length; E > P; f = ++P) c = d[f], m = document.createElement("div"), m.className = "odometer-value", m.innerHTML = c, this.ribbons[u].appendChild(m), f === d.length - 1 && v(m, "odometer-last-value"), 0 === f && v(m, "odometer-first-value");
                    return 0 > w && this.addDigit("-"), g = this.inside.querySelector(".odometer-radix-mark"), null != g && g.parent.removeChild(g), h ? this.addSpacer(this.format.radix, this.digits[h - 1], "odometer-radix-mark") : void 0
                }
            }, t
        }(), u.options = null != (I = window.odometerOptions) ? I : {}, setTimeout(function() {
            var t, e, i, n, o;
            if (window.odometerOptions) {
                n = window.odometerOptions, o = [];
                for (t in n) e = n[t], o.push(null != (i = u.options)[t] ? (i = u.options)[t] : i[t] = e);
                return o
            }
        }, 0), u.init = function() {
            var t, e, i, n, o, s;
            if (null != document.querySelectorAll) {
                for (e = document.querySelectorAll(u.options.selector || ".odometer"), s = [], i = 0, n = e.length; n > i; i++) t = e[i], s.push(t.odometer = new u({
                    el: t,
                    value: null != (o = t.innerText) ? o : t.textContent
                }));
                return s
            }
        }, null != (null != (M = document.documentElement) ? M.doScroll : void 0) && null != document.createEventObject ? (L = document.onreadystatechange, document.onreadystatechange = function() {
            return "complete" === document.readyState && u.options.auto !== !1 && u.init(), null != L ? L.apply(this, arguments) : void 0
    ...
    function() {
        ...
        var n = i.helpers = {},
            ...
            b = (n.splineCurve = function(t, e, i, n) {
            ...
            C = (n.calculateScaleRange = function(t, e, i, n, o) {
                var s = 2,
                ...
                for (var c = Math.abs(l - h), d = b(c), u = Math.ceil(l / (1 * Math.pow(10, d))) * Math.pow(10, d), p = n ? 0 : Math.floor(h / (1 * Math.pow(10, d))) * Math.pow(10, d), f = u - p, v = Math.pow(10, d), y = Math.round(f / v);
                    (y > a || a > 2 * y) && !r;)
            ...
            x = (n.generateLabels = function(t, e, i, n) {
                var s = new Array(e);
            ...
            T = (n.animationLoop = function(t, e, i, n, o, s) {
                var a = 0,
                    ...
                    l = function() {
                        ...
                        var i = a / e,
                            h = r(i);
                        t.call(s, h, i, a), n.call(s, h, i), e > a ? s.animationFrame = S(l) : o.apply(s)
                    };
                S(l)
            ...
            I = (n.getMaximumSize = n.getMaximumWidth, n.retinaScale = function(t) {
                var e = t.ctx,
                    i = t.canvas.width,
                    n = t.canvas.height;
        ...
        i.instances = {}, i.Type = function(t, e, n) {
            ...
            stop: function() {
                return A(this.animationFrame), this
            },
            resize: function(t) {
                this.stop();
                ...
                return e.width = this.chart.width = i, e.height = this.chart.height = n, I(this.chart), "function" == typeof t && t.apply(this, Array.prototype.slice.call(arguments, 1)), this
            },
            reflow: c,
            render: function(t) {
            ...
            draw: function() {
                ...
                t.font = B(this.fontSize, this.fontStyle, this.fontFamily), this.xAlign = "center", this.yAlign = "above";
            ...
            initialize: function() {
                this.font = B(this.fontSize, this.fontStyle, this.fontFamily), this.titleFont = B(this.titleFontSize, this.titleFontStyle, this.titleFontFamily), this.height = this.labels.length * this.fontSize + (this.labels.length - 1) * (this.fontSize / 2) + 2 * this.yPadding + 1.5 * this.titleFontSize, this.ctx.font = this.titleFont;
            ...
            buildYLabels: function() {
                this.yLabels = [];
                for (var t = v(this.stepValue), e = 0; e <= this.steps; e++) this.yLabels.push(C(this.templateString, {
            ...
            calculateXLabelRotation: function() {
                ...
                if (this.xScalePaddingRight = n / 2 + 3, this.xScalePaddingLeft = i / 2 > this.yLabelWidth + 10 ? i / 2 : this.yLabelWidth + 10, this.xLabelRotation = 0, this.display) {
                    var o, s = R(this.ctx, this.font, this.xLabels);
                    this.xLabelWidth = s;
            ...
            setScaleSize: function() {
                var t, e, i, n, o, s, a, r, l, h, c, d, u = m([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
                    p = this.width,
                    g = 0;
                for (this.ctx.font = B(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), e = 0; e < this.valuesCount; e++) t = this.getPointPosition(e, u), i = this.ctx.measureText(C(this.templateString, {
                    value: this.labels[e]
                ...
                if (this.display) {
                    ...
                    if (o(this.yLabels, function(e, i) {
                            if (i > 0) {
                                ...
                                if (this.showLabels) {
                                    if (t.font = B(this.fontSize, this.fontStyle, this.fontFamily), this.showLabelBackdrop) {
                        ...
                        for (var e = this.valuesCount - 1; e >= 0; e--) {
                            ...
                            t.font = B(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), t.fillStyle = this.pointLabelFontColor;
            ...
            draw: function(t) {
                ...
                this.scale.draw(e), i.each(this.datasets, function(t) {
                    ...
                    i.each(t.points, function(t, i) {
                        ...
                        }, this), n.lineWidth = this.options.datasetStrokeWidth,
                        n.strokeStyle = t.strokeColor, n.beginPath(), i.each(r, function(t, e) {
        ...
        p.style.cssText = "background-color:rgba(1,1,1,.5)", u.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(c, function(t, e) {
            ...
            parse: function(o, a, r, l) {
                ...
                var d = this,
                    u = t.type(o),
                    p = this._rgba = [];
                return a !== e && (o = [o, a, r, l], u = "array"), "string" === u ? this.parse(n(o) || s._default) : "array" === u ? (f(c.rgba.props, function(t, e) {
                    p[e.idx] = i(o[e.idx], e)
                }), this) : "object" === u ? (o instanceof h ? f(c, function(t, e) {
            ...
            var e, i, n = t[0] / 255,
                ...
                c = r + l,
                d = .5 * c;
            return e = l === r ? 0 : n === r ? 60 * (o - s) / h + 360 : o === r ? 60 * (s - n) / h + 120 : 60 * (n - o) / h + 240, i = 0 === h ? 0 : d <= .5 ? h / c : h / (2 - c), [Math.round(e) % 360, i, d, null == a ? 1 : a]
            ...
            h.fn[n] = function(n) {
                ...
                h.fn[e] || (h.fn[e] = function(o) {
                    var s, a = t.type(o),
                        ...
                        h = this[l](),
                        c = h[i.idx];
                    return "undefined" === a ? c : ("function" === a && (o = o.call(this, c), a = t.type(o)), null == o && i.empty ? this : ("string" === a && (s = r.exec(o), s && (o = c + parseFloat(s[2]) * ("+" === s[1] ? 1 : -1))), h[i.idx] = o, this[l](h)))
                })
            })
        }), h.hook = function(e) {
            var i = e.split(" ");
    ...
    function(t, e, i) {
        ...
        function n(i) {
            if (o = e.documentElement, s = e.body, $(), rt = this, i = i || {}, ut = i.constants || {}, i.easing)
                for (var n in i.easing) V[n] = i.easing[n];
            wt = i.edgeStrategy || "set", ct = {
                beforerender: i.beforerender,
                render: i.render,
                keyframe: i.keyframe
            }, dt = i.forceHeight !== !1, dt && (Ot = i.scale || 1), pt = i.mobileDeceleration || A, gt = i.smoothScrolling !== !1, mt = i.smoothScrollingDuration || k, vt = {
            ...
            })(), Qt ? (ht = e.getElementById(i.skrollrBody || T), ht && at(), Y(), It(o, [y, C], [w])) : It(o, [y, b], [w]), rt.refresh(), xt(t, "resize orientationchange", function() {
                var t = o.clientWidth,
                    e = o.clientHeight;
                e === Nt && t === jt || (Nt = e, jt = t, Ht = !0)
            });
            var a = U();
            return function r() {
                Z(), Ct = a(r)
        ...
        var o, s, a = {
            ...
            $ = function() {
                ...
                if (h) {
                    ...
                    if (!q) return void(q = Q = "");
                    q = q[0], "-" === q.slice(0, 1) ? (Q = q, q = {
                        "-webkit-": "webkit",
                        "-moz-": "Moz",
                        "-ms-": "ms",
                        "-o-": "O"
        ...
        n.prototype.refresh = function(t) {
            ...
            for (t === i ? (s = !0, lt = [], qt = 0, t = e.getElementsByTagName("*")) : t.length === i && (t = [t]), n = 0, o = t.length; n < o; n++) {
                var a = t[n],
                    ...
                    c = wt,
                    d = !1;
                if (s && M in a && delete a[M], a.attributes) {
                    for (var u = 0, p = a.attributes.length; u < p; u++) {
                        var g = a.attributes[u];
                        if ("data-anchor-target" !== g.name)
                            if ("data-smooth-scrolling" !== g.name)
                                if ("data-edge-strategy" !== g.name)
                                    if ("data-emit-events" !== g.name) {
                                        var m = g.name.match(F);
                                        if (null !== m) {
                                            var v = {
                                                props: g.value,
                                                element: a,
                                                eventType: g.name.replace(_, z)
                                            };
                                            l.push(v);
                                            var y = m[1];
                                            ...
                                            var b = m[3],
                                                C = m[4] || b;
                                            b && b !== E && b !== P ? (v.mode = "relative", v.anchors = [b, C]) : (v.mode = "absolute", b === P ? v.isEnd = !0 : v.isPercentage || (v.offset = v.offset * Ot))
                                        }
                                    } else d = !0;
                        else c = g.value;
                        else h = "off" !== g.value;
                        else if (r = e.querySelector(g.value), null === r) throw 'Unable to find anchor target "' + g.value + '"'
                    }
                    if (l.length) {
                        var x, S, A;
                        !s && M in a ? (A = a[M], x = lt[A].styleAttr, S = lt[A].classAttr) : (A = a[M] = qt++, x = a.style.cssText, S = Lt(a)), lt[A] = {
                            element: a,
                            styleAttr: x,
                            classAttr: S,
                            anchorTarget: r,
            ...
            var n = o.clientHeight,
                ...
                a = s.top,
                r = s.bottom - s.top;
            return e === I ? a -= n : e === L && (a -= n / 2), i === I ? a += r : i === L && (a += r / 2), a += rt.getScrollTop(), a + .5 | 0
            ...
            return yt = i === !0, Qt ? $t = l.min(l.max(e, 0), Dt) : t.scrollTo(0, e), rt
        }, n.prototype.getScrollTop = function() {
            return Qt ? $t : t.pageYOffset || o.scrollTop || s.scrollTop || 0
            ...
            var t = G();
            t(Ct), At(), It(o, [w], [y, b, C]);
            for (var e = 0, n = lt.length; e < n; e++) st(lt[e].element);
            o.style.overflow = s.style.overflow = "", o.style.height = s.style.height = "", ht && a.setStyle(ht, "transform", "none"), rt = i, ht = i, ct = i, dt = i, Dt = 0, Ot = 1, ut = i, pt = i, _t = "down", zt = -1, jt = 0, Nt = 0, Ht = !1, ft = i, gt = i, mt = i, vt = i, yt = i, qt = 0, wt = i, Qt = !1, $t = 0, bt = i
        };
        var Y = function() {
                var n, a, r, h, f, g, m, v, y, w, b, C;
                xt(o, [c, d, u, p].join(" "), function(t) {
                    var o = t.changedTouches[0];
                    for (h = t.target; 3 === h.nodeType;) h = h.parentNode;
                    switch (f = o.clientY, g = o.clientX, w = t.timeStamp, B.test(h.tagName) || t.preventDefault(), t.type) {
                        case c:
                            n && n.blur(), rt.stopAnimateTo(), n = h, a = m = f, r = g, y = w;
                            break;
                        case d:
                            B.test(h.tagName) && e.activeElement !== h && t.preventDefault(), v = f - m, C = w - b, rt.setScrollTop($t - v, !0), m = f, b = w;
                            break;
                        default:
                        case u:
                        case p:
                            ...
                            if (S < 49) {
                                if (!B.test(n.tagName)) {
                                    ...
                                    A.initMouseEvent("click", !0, !0, t.view, 1, o.screenX, o.screenY, o.clientX, o.clientY, t.ctrlKey, t.altKey, t.shiftKey, t.metaKey, 0, null), n.dispatchEvent(A)
                                }
                                return
                            }
                            n = i;
                            ...
                            var k = l.abs(T / pt),
                                ...
                                P = rt.getScrollTop() - E,
                                L = 0;
                            P > Dt ? (L = (Dt - P) / E, P = Dt) : P < 0 && (L = -P / E, P = 0), k *= 1 - L, rt.animateTo(P + .5 | 0, {
                                easing: "outCubic",
                                duration: k
                            })
                    }
            ...
            X = function() {
                var t, e, i, n, s, a, r, h, c, d, u, p = o.clientHeight,
                    f = Et();
                for (h = 0, c = lt.length; h < c; h++)
                    for (t = lt[h], e = t.element, i = t.anchorTarget, n = t.keyFrames, s = 0, a = n.length; s < a; s++) r = n[s], d = r.offset, u = f[r.constant] || 0, r.frame = d, r.isPercentage && (d *= p, r.frame = d), "relative" === r.mode && (st(e), r.frame = rt.relativeToAbsolute(i, r.anchors[0], r.anchors[1]) - d, st(e, !0)), r.frame += u, dt && !r.isEnd && r.frame > Dt && (Dt = r.frame);
                for (Dt = l.max(Dt, Pt()), h = 0, c = lt.length; h < c; h++) {
                    for (t = lt[h], n = t.keyFrames, s = 0, a = n.length; s < a; s++) r = n[s], u = f[r.constant] || 0, r.isEnd && (r.frame = Dt - r.offset + u);
                    t.keyFrames.sort(Ft)
                }
            },
            K = function(t, e) {
                for (var i = 0, n = lt.length; i < n; i++) {
                    var o, s, l = lt[i],
                        ...
                        S = l.lastFrameIndex;
                    if (w || b) {
                        if (w && l.edge === -1 || b && 1 === l.edge) continue;
                        switch (w ? (It(h, [g], [v, m]), x && S > -1 && (Tt(h, p.eventType, _t), l.lastFrameIndex = -1)) : (It(h, [v], [g, m]), x && S < u && (Tt(h, y.eventType, _t), l.lastFrameIndex = u)), l.edge = w ? -1 : 1, l.edgeStrategy) {
                            case "reset":
                                st(h);
                                continue;
                            case "ease":
                            ...
                            case "set":
                                var A = C.props;
                                for (o in A) r.call(A, o) && (s = ot(A[o].value), 0 === o.indexOf("@") ? h.setAttribute(o.substr(1), s) : a.setStyle(h, o, s));
                                continue
                        }
                    } else 0 !== l.edge && (It(h, [f, m], [g, v]), l.edge = 0);
                    for (var T = 0; T < u - 1; T++)
                        if (c >= d[T].frame && c <= d[T + 1].frame) {
                            var k = d[T],
                                E = d[T + 1];
                            for (o in k.props)
                                if (r.call(k.props, o)) {
                                    var P = (c - k.frame) / (E.frame - k.frame);
                                    P = k.props[o].easing(P), s = nt(k.props[o].value, E.props[o].value, P), s = ot(s), 0 === o.indexOf("@") ? h.setAttribute(o.substr(1), s) : a.setStyle(h, o, s)
                                }
                            x && S !== T && ("down" === _t ? Tt(h, k.eventType, _t) : Tt(h, E.eventType, _t), l.lastFrameIndex = T);
                            break
                        }
                }
            },
            Z = function() {
                ...
                if (ft) o >= ft.endTime ? (n = ft.targetTop, t = ft.done, ft = i) : (e = ft.easing((o - ft.startTime) / ft.duration), n = ft.startTop + e * ft.topDiff | 0), rt.setScrollTop(n, !0);
                    ...
                    s && (vt = {
                        ...
                        startTime: Wt,
                        endTime: Wt + mt
                    }), o <= vt.endTime && (e = V.sqrt((o - vt.startTime) / mt), n = vt.startTop + e * vt.topDiff | 0)
                }
                if (yt || zt !== n) {
                    _t = n > zt ? "down" : n < zt ? "up" : _t, yt = !1;
                    var r = {
                            curTop: n,
                            lastTop: zt,
                            maxTop: Dt,
                    ...
                    l !== !1 && (K(n, rt.getScrollTop()), Qt && ht && a.setStyle(ht, "transform", "translate(0, " + -$t + "px) " + bt), zt = n, ct.render && ct.render.call(rt, r)), t && t.call(rt, !1)
                }
                Wt = o
            },
            J = function(t) {
                for (var e = 0, i = t.keyFrames.length; e < i; e++) {
                    for (var n, o, s, a, r = t.keyFrames[e], l = {}; null !== (a = D.exec(r.props));) s = a[1], o = a[2], n = s.match(O), null !== n ? (s = n[1], n = n[2]) : n = x, o = o.indexOf("!") ? tt(o) : [o.slice(1)], l[s] = {
                        value: o,
                        easing: V[n]
                    };
                    r.props = l
            ...
            tt = function(t) {
                var e = [];
                return N.lastIndex = 0, t = t.replace(N, function(t) {
            ...
            st = function(t, e) {
                t = [].concat(t);
                for (var i, n, o = 0, s = t.length; o < s; o++) n = t[o], i = lt[n[M]], i && (e ? (n.style.cssText = i.dirtyStyleAttr, It(n, i.dirtyClassAttr)) : (i.dirtyStyleAttr = n.style.cssText, i.dirtyClassAttr = Lt(n), n.style.cssText = i.styleAttr, It(n, i.classAttr)))
            },
            at = function() {
                bt = "translateZ(0)", a.setStyle(ht, "transform", bt);
                var t = h(ht),
        ...
        a.setStyle = function(t, e, i) {
            var n = t.style;
            if (e = e.replace(_, z).replace("-", ""), "zIndex" === e) isNaN(i) ? n[e] = i : n[e] = "" + (0 | i);
            else if ("float" === e) n.styleFloat = n.cssFloat = i;
            else try {
                q && (n[q + e.slice(0, 1).toUpperCase() + e.slice(1)] = i), n[e] = i
            } catch (o) {}
        };
        var rt, lt, ht, ct, dt, ut, pt, ft, gt, mt, vt, yt, wt, bt, Ct, xt = a.addEvent = function(e, i, n) {
                var o = function(e) {
            ...
            kt = function() {
                ...
                Dt = 0, dt && !Qt && (s.style.height = ""), X(), dt && !Qt && (s.style.height = Dt + o.clientHeight + "px"), Qt ? rt.setScrollTop(l.min(rt.getScrollTop(), Dt)) : rt.setScrollTop(t, !0), yt = !0
            },
            Et = function() {
                var t, e, i = o.clientHeight,
                    n = {};
                for (t in ut) e = ut[t], "function" == typeof e ? e = e.call(rt) : /p$/.test(e) && (e = e.slice(0, -1) / 100 * i), n[t] = e;
                return n
            },
            Pt = function() {
                var t, e = 0;
            ...
            It = function(e, n, o) {
                ...
                for (var a = e[s], r = 0, l = o.length; r < l; r++) a = Bt(a).replace(Bt(o[r]), " ");
                a = Mt(a);
                for (var h = 0, c = n.length; h < c; h++) Bt(a).indexOf(Bt(n[h])) === -1 && (a += " " + n[h]);
                e[s] = Mt(a)
            },
            Mt = function(t) {
                return t.replace(R, "")
    ...
    function(t, e) {
        ...
        function i(t, e, i, n, o, s, a) {
            ...
            if (a = "number" == typeof a ? a : 0, t.css(i, n + s), r = t.width(), r >= e) {
                ...
                return {
                    match: "estimate",
                    size: parseFloat((parseFloat(n) - ("word-spacing" === i && a && h < l ? 0 : o)).toFixed(3))
                }
            }
            return r
        }
        ...
        function n(t, n, o, s, a) {
            ...
            return n.css("float", "left").each(function() {
                var t, n, r = e(this),
                    c = l.supports.wholeNumberFontSizeOnly ? [8, 4, 1] : [8, 4, 1, .1];
                if (r.hasClass(l.EXEMPT_CLASS)) return h.push(null), u.push(null), void d.push(!1);
                var p = 32,
                    f = parseFloat(r.css("font-size")),
                    g = (r.width() / f).toFixed(6);
                n = parseInt(o / g, 10) - p;
                t: for (var m = 0, v = c.length; m < v; m++) e: for (var y = 1, w = 10; y <= w; y++) {
                    if (n + y * c[m] > s) {
                        n = s;
                        break t
                    }
                    if (t = i(r, o, "font-size", n + y * c[m], c[m], "px", t), "number" != typeof t) {
                        if (n = t.size, "exact" === t.match) break t;
                        break e
                    }
                }
                u.push(o / n), n > s ? (h.push(s), d.push(!1)) : a && n < a ? (h.push(a), d.push(!0)) : (h.push(n), d.push(!1))
            }).each(function(t) {
                var n, s = e(this),
                    a = 0,
                    r = 1;
                if (s.hasClass(l.EXEMPT_CLASS)) return void c.push(null);
                s.css("font-size", h[t] + "px");
                for (var d = 1, u = 3; d < u; d += r)
                    if (n = i(s, o, "word-spacing", d, r, "px", n), "number" != typeof n) {
                        a = n.size;
                        break
                    }
                s.css("font-size", ""), c.push(a)
                ...
                jQueryMethod: function(t) {
                    return l.init(), t = e.extend({
                        ...
                        var i = e(this).addClass("bigtext"),
                            a = i.width(),
                            r = i.attr("id"),
                            h = t.childSelector ? i.find(t.childSelector) : i.children();
                        r || (r = "bigtext-id" + o++, i.attr("id", r)), t.resize && l.bindResize("resize.bigtext-event-" + r, function() {
                            l.jQueryMethod.call(e("#" + r), t)
                        }), l.clearCss(r), h.addClass(function(t, e) {
                            return [e.replace(new RegExp("\\b" + l.LINE_CLASS_PREFIX + "\\d+\\b"), ""), l.LINE_CLASS_PREFIX + t].join(" ")
                        });
                        var c = n(i, h, a, t.maxfontsize, t.minfontsize);
                        s.append(l.generateCss(r, c.fontSizes, c.wordSpacings, c.minFontSizes))
...
window.paceOptions = {
        ...
        function o(e) {
            ...
            e.each(function() {
                var e = t(this);
                if (e.hasClass("loading-bar")) i = u, setTimeout(function() {
        ...
        function s(t) {
            ...
            if (t.parents(".cd-headline").hasClass("type")) {
                ...
                c(t, e), a(e)
            }) : t.parents(".cd-headline").hasClass("loading-bar") ? (t.parents(".cd-words-wrapper").removeClass("is-loading"), c(t, e), setTimeout(function() {
                s(e)
            }, u), setTimeout(function() {
                t.parents(".cd-words-wrapper").addClass("is-loading")
            }, p)) : (c(t, e), setTimeout(function() {
                s(e)
            }, d))
        }
    ...
    function() {
        var t, e, i, n, o, s, a, r, l, h, c, d, u, p, f, g, m, v, y, w, b, C, x, S, A, T, k, E, P, L, I, M, B, R, F, D, O, _, z, W, j, N, H, q, Q, $, U, G, V, Y = [].slice,
            X = {}.hasOwnProperty,
            K = function(t, e) {
                function i() {
                    this.constructor = t
        ...
        for (b = {
                ...
                for (e = arguments[0], n = 2 <= arguments.length ? Y.call(arguments, 1) : [], s = 0, a = n.length; s < a; s++)
                    if (i = n[s])
                        for (t in i) X.call(i, t) && (o = i[t], null != e[t] && "object" == typeof e[t] && null != o && "object" == typeof o ? C(e[t], o) : e[t] = o);
                return e
            }, m = function(t) {
                var e, i, n, o, s;
            ...
            }(), h = window.Pace || {}, window.Pace = h, C(h, a.prototype), L = h.options = C({}, b, window.paceOptions, S()), U = ["ajax", "document", "eventLag", "elements"], H = 0, Q = U.length; H < Q; H++) O = U[H], L[O] === !0 && (L[O] = b[O]);
        l = function(t) {
            function e() {
            ...
            return t.prototype.getElement = function() {
                var t;
                if (null == this.el) {
                    if (t = document.querySelector(L.target), !t) throw new l;
        ...
        }(), N = window.XMLHttpRequest, j = window.XDomainRequest, W = window.WebSocket, x = function(t, e) {
            var i, n, o;
            o = [];
            ...
            function e() {
                ...
                e.__super__.constructor.apply(this, arguments), t = function(t) {
                    ...
                    var i;
                    return i = new N(e), t(i), i
                };
                try {
                    x(window.XMLHttpRequest, N)
                } catch (n) {}
                if (null != j) {
                ...
                if (null != W && L.ajax.trackWebSockets) {
                    window.WebSocket = function(t, e) {
                        var n;
                        return n = null != e ? new W(t, e) : new W(t), D("socket") && i.trigger("request", {
                            type: "socket",
                            url: t,
                            protocols: e,
                            request: n
                    ...
                    try {
                        x(window.WebSocket, W)
                    } catch (n) {}
                }
            }
            return K(e, t), e
        }(r), q = null, A = function() {
            return null == q && (q = new c), q
        }, F = function(t) {
            var e, i, n, o;
            for (o = L.ajax.ignoreURLs, i = 0, n = o.length; i < n; i++)
            ...
            var i, n, o, s, a;
            if (s = e.type, o = e.request, a = e.url, !F(a)) return h.running || L.restartOnRequestAfter === !1 && "force" !== D(s) ? void 0 : (n = arguments, i = L.restartOnRequestAfter || 0, "boolean" == typeof i && (i = 0), setTimeout(function() {
                var e, i, a, r, l, c;
                if (e = "socket" === s ? o.readyState < 2 : 0 < (r = o.readyState) && r < 4) {
                    for (h.restart(), l = h.sources, c = [], i = 0, a = l.length; i < a; i++) {
            ...
            return t.prototype.watch = function(t) {
                var e, i, n, o;
                if (n = t.type, e = t.request, o = t.url, !F(o)) return i = "socket" === n ? new p(e) : new f(e), this.elements.push(i)
            }, t
        }(), f = function() {
            function t(t) {
            ...
            function t() {
                ...
                this.progress = 0, t = 0, o = [], n = 0, i = P(), e = setInterval(function() {
                    var a;
                    return a = P() - i - 50, i = P(), o.push(a), o.length > L.eventLag.sampleCount && o.shift(), t = m(o), ++n >= L.eventLag.minSamples && t < L.eventLag.lagThreshold ? (s.progress = 100, clearInterval(e)) : s.progress = 100 * (3 / (t + 3))
                }, 50)
            }
            return t
        }(), u = function() {
            function t(t) {
                this.source = t, this.last = this.sinceLastUpdate = 0, this.rate = L.initialRate, this.catchup = 0, this.progress = this.lastProgress = 0, null != this.source && (this.progress = M(this.source, "progress"))
            }
        ...
        }(), _ = null, R = null, v = null, z = null, g = null, y = null, h.running = !1, T = function() {
            ...
            var t, i, n, o, s, a, r, l;
            for (h.sources = _ = [], a = ["ajax", "elements", "document", "eventLag"], i = 0, o = a.length; i < o; i++) t = a[i], L[t] !== !1 && _.push(new d[t](L[t]));
            for (l = null != (r = L.extraSources) ? r : [], n = 0, s = l.length; n < s; n++) O = l[n], _.push(new O(L));
            return h.bar = v = new e, R = [], z = new u
        })(), h.stop = function() {
            return h.trigger("stop"), h.running = !1, v.destroy(), y = !0, null != g && ("function" == typeof w && w(g), g = null), E()
        }, h.restart = function() {
            return h.trigger("restart"), h.stop(), h.start()
        }, h.go = function() {
            var t;
            return h.running = !0, v.render(), t = P(), y = !1, g = B(function(e, i) {
                var n, o, s, a, r, l, c, d, p, f, g, m, w, b, C, x;
                for (d = 100 - v.progress, o = g = 0, s = !0, l = m = 0, b = _.length; m < b; l = ++m)
                    for (O = _[l], f = null != R[l] ? R[l] : R[l] = [], r = null != (x = O.elements) ? x : [O], c = w = 0, C = r.length; w < C; c = ++w) a = r[c], p = null != f[c] ? f[c] : f[c] = new u(a), s &= p.done, p.done || (o++, g += p.tick(e));
                return n = g / o, v.update(z.tick(e, n)), v.done() || s || y ? (v.update(100), h.trigger("done"), setTimeout(function() {
                    return v.finish(), h.running = !1, h.trigger("hide")
                }, Math.max(L.ghostTime, Math.max(L.minTime - (P() - t), 0)))) : i()
            })
        }, h.start = function(t) {
            C(L, t), h.running = !0;
            try {
